...
**Related:** [Project README / feature catalog](../README.md#23-feature-catalog) · [ADRs](../docs/adr/README.md) · [Quality attributes (NFRs)](../docs/nfr/README.md) · [Living reference](./reference/README.md) · [Constitution](../.cursor/rules/constitution.mdc)
...
Every new feature uses `features/feature-N-short-name.md` with these sections **in order**. Copy [feature-1-user-authentication-session-management.md](./feature-1-user-authentication-session-management.md) as the canonical example.
...
| Situation | Action |
|-----------|--------|
| New capability | New `feature-(N+1)-….md` + row in [project README](../README.md#23-feature-catalog) catalog |
...
- [ ] **Catalog** — [project README](../README.md#23-feature-catalog) row for new features; ADR links if architecture changed.
...
- [ ] Add row to [project README](../README.md#23-feature-catalog) catalog
...
PDF and Agility both pick up new `features/feature-N-*.md` automatically. See [docs/agility-import/README.md](../docs/agility-import/README.md).
